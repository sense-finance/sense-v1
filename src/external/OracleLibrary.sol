...
library OracleLibrary {
    ...
    function consult(address pool, uint32 period) internal view returns (int24 timeWeightedAverageTick) {
        ...
        timeWeightedAverageTick = int24(tickCumulativesDelta / int56(int32(period))); // TODO: check casting

        // Always round to negative infinity
        if (tickCumulativesDelta < 0 && (tickCumulativesDelta % int56(int32(period)) != 0)) timeWeightedAverageTick--; // TODO check casting
    }
    ...
    function getBlockStartingTick(address pool) internal view returns (int24) {
        ...
        return int24((tickCumulative - prevTickCumulative) / int56(int32(observationTimestamp - prevObservationTimestamp))); // TODO: check casting
    }
}
