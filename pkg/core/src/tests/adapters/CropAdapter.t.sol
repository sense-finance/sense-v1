...
contract CropAdapters is TestHelper {
    ...
    function testFuzzCanDiluteRewardsIfReconciledAndCombineS1_YTsFirstI(uint256 tBal) public {
        ...
        assertClose(ERC20(reward).balanceOf(bob), 110 * 1e18);
        ...
        assertClose(adapter.reconciledAmt(bob), 0);
        assertClose(adapter.tBalance(bob), (60 * tBal) / 100);
    }
    ...
    function testFuzzCanDiluteRewardsIfReconciledAndCombineS1_YTsFirstII(uint256 tBal) public {
        ...
        assertClose(ERC20(reward).balanceOf(alice), 111428571428571428874);
        // Bob should receive 20 out of those 50 rewards
        // but, instead, he receives ~28.57 (totaling 60 + ~28.57 = ~88.57)
        assertClose(ERC20(reward).balanceOf(bob), 88571428571428571124);
    ...
    // CAN DILUTE??
    // Alice combines half of her S2-YTs first, then half of her S1-YTs, then the rest of her S2-YTs and S1-YTs
    ...
    //     assertClose(adapter.tBalance(alice), 0);
    //     assertClose(adapter.reconciledAmt(alice), (100 * tBal) / 100);
    ...
    //     divider.issue(address(adapter), newMaturity, (50 * tBal) / 100);
    //     assertClose(adapter.reconciledAmt(alice), (50 * tBal) / 100);
    //     assertClose(adapter.tBalance(alice), (50 * tBal) / 100);
    //     assertClose(ERC20(reward).balanceOf(alice), 10 * 1e18);

    //     // alice combines half of her new Series YTs
    //     divider.combine(address(adapter), newMaturity, ERC20(newYt).balanceOf(alice) / 2);
    //     assertClose(adapter.reconciledAmt(alice), (25 * tBal) / 100);
    //     assertClose(adapter.tBalance(alice), (25 * tBal) / 100);
    ...
    // // CAN DILUTE??
    // // Alice combines half of her S1-YTs first, then half of her S2-YTs, then the rest of her S1-YTs and S2-YTs
    ...
    //     divider.combine(address(adapter), maturity, ERC20(yt).balanceOf(alice) / 2);
    //     assertClose(adapter.reconciledAmt(alice), 0);
    //     assertClose(adapter.tBalance(alice), (50 * tBal) / 100); // THIS FAILS!!!
